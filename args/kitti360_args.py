...
def parse_kitti360_args(cli_args=None):
    parser = argparse.ArgumentParser(description='KITTI-360 Model Arguments')
    # seed
    ...
    # dataset
    parser.add_argument('--dataset', default='kitti360', type=str, help='kitti360')
    parser.add_argument('--kitti360_root', default='/data_sair/kitti360_maps/submaps', type=str, help='KITTI-360 submaps root directory')
    parser.add_argument('--gpu_ids', default='0', type=str, help='comma-separated visible GPU indices for DataParallel, e.g. 0,1,2')
    parser.add_argument('--val_ratio', default=0.1, type=float, help='validation ratio within KITTI-360 frames')
    parser.add_argument('--split_seed', default=21, type=int, help='seed for KITTI-360 train/val split')
    parser.add_argument('--eval_split', default='val', type=str, help='evaluation split for training: val or test')
    parser.add_argument('--overfit_test_split', default=False, type=str2bool, help='if true, train on KITTI-360 eval split for overfitting diagnostics')
    ...
    parser.add_argument('--num_points', default=10520, type=int, help='the points number of each input patch before occlusion')
    ...
    parser.add_argument(
        ...
        '--kitti360_use_preprocessed_input',
    ...
    parser.add_argument('--wandb_project', default='SuperPC_kitti360', type=str, help='wandb project name')
    parser.add_argument('--wandb_entity', default=None, type=str, help='wandb entity/user/team')
    parser.add_argument('--wandb_run_name', default='kitti360_with_image_run_128d', type=str, help='wandb run name')
