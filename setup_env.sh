...
echo "  python test_superpc.py --model superpc --test_input_path example/camel.xyz --up_rate 4"
echo ""
echo "To run the Depth Anything v2 overlap sanity test, try:"
echo "  python test_depth_anything_overlap.py --cat-id 02691156 --model-id 1a04e3eab45ca15dd86060f189eb133 --mode easy --view-index 0"
echo ""
