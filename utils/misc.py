...
def get_new_log_dir(argsinfo, root='./logs', postfix='', prefix=''):
    ...
    log_dir = os.path.join(root, argsinfo.project_name + '_' + prefix + timeSt + postfix + '_' + argsinfo.run_name + '_latentDim' + str(argsinfo.latent_dim) + '_inputDownsample' + str(argsinfo.input_downsample))
    os.makedirs(log_dir)
    return log_dir
