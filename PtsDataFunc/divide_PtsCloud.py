...
#     x = pts_xyz[0].sort()[1]
#     part1 = pts_xyz[pts_xyz[:, 0] < pts_xyz[:, 0].sort()[0][int(pts_xyz.size()[0]/2)-1]]
#     part2 = pts_xyz[pts_xyz[:, 0] > pts_xyz[:, 0].sort()[0][int(pts_xyz.size()[0]/2)-1]]
#     midx = pts_xyz[pts_xyz[:, 0] == pts_xyz[:, 0].sort()[0][int(pts_xyz.size()[0]/2)-1]]

#     num1 = int(pts_xyz.size()[0]/2 - part1.size()[0])
#     num2 = int(pts_xyz.size()[0]/2 - part2.size()[0])
#     part1 = torch.cat((part1, midx[:num1]), 0)
#     part2 = torch.cat((part1, midx[-num2:]), 0)
